      ...
      <div className="boody" id="fisioterapeuta">
        <div className="container">
          <div className="box">
            ...
            <p>
              Fisioterapeuta especializado e focado em reabilitação
              musculoesquelética.
            </p>
            <div className="btns">
          ...
          <div className="box">
            ...
            <p>
              Psicólogo dedicado a facilitar jornadas de autodescoberta e
              bem-estar.
            </p>
            <div className="btns">
              <button type="submit">Agendar</button>
          ...
          <div className="box">
            ...
            <p>
              Nutricionista comprometido em promover hábitos alimentares
              saudáveis.
            </p>
            <div className="btns">
              <button type="submit">Agendar</button>
