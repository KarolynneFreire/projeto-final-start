import "../SobreNos/assets/css/styles.css"
import missaoImg from "../SobreNos/assets/img/missao.png"
import visaoImg from "../SobreNos/assets/img/visao.png"
import valorImg from "../SobreNos/assets/img/valor.png"
        ...
        <div className="tudo">
            ...
            <div className="visao">
                ...
                <div className="textoVisao">
                    <h2>Visão</h2>
                    <p>Buscamo ser uma plataforma líder em serviços de saúde online, destacada por contribuir significativamente para a promoção da saúde, especialmente para pessoas de baixa renda.</p>
                </div>
            </div>
